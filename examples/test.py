...
from ICSR.models.dsbn import convert_dsbn, convert_bn
from ICSR.evaluators import Evaluator
...
from ICSR.utils.serialization import load_checkpoint, save_checkpoint, copy_state_dict
...
if __name__ == '__main__':
    ...
    parser.add_argument('--resume', type=str,
                        default="logs/msmt/model_best.pth.tar",
                        metavar='PATH')
    # testing configs
